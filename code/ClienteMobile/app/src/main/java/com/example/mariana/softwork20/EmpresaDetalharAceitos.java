...
public class EmpresaDetalharAceitos extends AppCompatActivity {

    ImageButton ibDetalhaAppMensagem;
    ...
    static final int CODIGO_EMPRESA_ENVIA_MSG = 1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_empresa_detalhar_aceitos);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        ibDetalhaAppMensagem = findViewById(R.id.ibDetalhaAppMensagem);
        ...
        ibDetalhaAppMensagem.setOnClickListener(trataClique);
    ...
    View.OnClickListener trataClique = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (view.getId() == ibDetalhaAppMensagem.getId()){
                Intent it = new Intent(EmpresaDetalharAceitos.this, EmpresaEnviaMensagem.class);
                it.putExtra("empresa", minhaEmpresa);
                it.putExtra("app", minhaApp);
                it.putExtra("aluno",meuAluno);
                startActivityForResult(it,CODIGO_EMPRESA_ENVIA_MSG);
            }
        }
    };
