...
public class AlunoAceitos extends javax.swing.JFrame {
    ...
    public AlunoAceitos(Aluno meuAluno, Socket cliente, ObjectOutputStream out, ObjectInputStream in, String[] alfabetosCriptografia) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTAplicacoesAceitas = new javax.swing.JTable();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLOfertas, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(25, 25, 25)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jTAplicacoesAceitas.setFont(new java.awt.Font("Calibri Light", 0, 14)); // NOI18N
        jTAplicacoesAceitas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jTAplicacoesAceitas.setRowHeight(35);
        jTAplicacoesAceitas.setRowMargin(10);
        jScrollPane1.setViewportView(jTAplicacoesAceitas);
    ...
    private void jBDetalharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDetalharActionPerformed
        if (jTAplicacoesAceitas.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(rootPane, "Selecione uma aplicação para detalhar.");
        } else {
            int x = jTAplicacoesAceitas.getSelectedRow();
            String selecionadaNome = (String) jTAplicacoesAceitas.getValueAt(x, 0);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        model = (DefaultTableModel) jTAplicacoesAceitas.getModel();
        model.setNumRows(0);
    ...
    private javax.swing.JTable jTAplicacoesAceitas;
