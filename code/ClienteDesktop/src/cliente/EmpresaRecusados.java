...
public class EmpresaRecusados extends javax.swing.JFrame {
    ...
    public EmpresaRecusados(Empresa minhaEmpresa, Socket cliente, ObjectOutputStream out, ObjectInputStream in, String[] alfabetosCriptografia) {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            out.writeObject("listaRecusadosEmpresa");
            ...
            if (mensagemRecebida.equals("Ok")) {
                ...
                if (mensagemRecebida.equals("temAplicacoes")) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Não há aplicações recusadas!");
                }
