...
public class AlunoEmEspera extends javax.swing.JFrame {
    ...
    public AlunoEmEspera(Aluno meuAluno, Socket cliente, ObjectOutputStream out, ObjectInputStream in, String[] alfabetosCriptografia) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTAplicacoesEmEspera = new javax.swing.JTable();
        ...
        jLEmEspera.setFont(new java.awt.Font("Calibri Light", 1, 18)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLBemVindo)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLSair, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(24, 24, 24)
        ...
        jTAplicacoesEmEspera.setFont(new java.awt.Font("Calibri Light", 0, 14)); // NOI18N
        jTAplicacoesEmEspera.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jTAplicacoesEmEspera.setRowHeight(35);
        jTAplicacoesEmEspera.setRowMargin(10);
        jScrollPane1.setViewportView(jTAplicacoesEmEspera);
    ...
    private void jBDetalharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDetalharActionPerformed
        if (jTAplicacoesEmEspera.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(rootPane, "Selecione uma aplicação para detalhar.");
        } else {
            int x = jTAplicacoesEmEspera.getSelectedRow();
            String selecionadaNome = (String) jTAplicacoesEmEspera.getValueAt(x, 0);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        model = (DefaultTableModel) jTAplicacoesEmEspera.getModel();
        model.setNumRows(0);
        ...
        try {
            ...
            if (mensagemRecebida.equals("Ok")) {
                ...
                if (mensagemRecebida.equals("temVagas")) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Não há aplicações em espera!");
                }
    ...
    private javax.swing.JTable jTAplicacoesEmEspera;
